...
* `use_managed_identity`: enable Azure managed identity authentication, both system-assigned and user-assigned
...
```sh
# add a store
$ plakar add store azblob://container_name connection_string="DefaultEndpointsProtocol=https;AccountName=account_name;AccountKey=account_key;EndpointSuffix=core.windows.net"
$ plakar add store azblob://container_name account_name="account_name" use_managed_identity=true
